...
>├── wordpress/ #Wordpress on Docker config files and compose yml
...
| [WordPress](https://wordpress.org/)  | Self-hosted CMS / website platform containerized |
...
4. Launch all services:
   ...
   ```
   <br>
> ⚠️ **WordPress Deployment notes:** 
> * WordPress is not deployed from the root `docker-compose.yml`.  To deploy WordPress, use the dedicated compose file located in: `/docker/wordpress`.
> * Additionally, `/docker/wordpress` path contains a backup script for persistent data and volumes. 
> </br>
   ---
